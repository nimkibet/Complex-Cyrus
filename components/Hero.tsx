  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Company Badge */}
        <motion.div variants={itemVariants} className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-2 mb-6 backdrop-blur-sm">
        ...
        {/* Main Headline */}
        <motion.h1 variants={itemVariants} className="text-4xl sm:text-5xl lg:text-7xl font-black text-white leading-tight mb-4">
          Complex{" "}
        ...
        {/* Subheadings */}
        <motion.p variants={itemVariants} className="text-xl sm:text-2xl lg:text-3xl font-bold text-blue-200 mt-4 mb-2">
          Powering Safety. Delivering Excellence.
        </motion.p>
        <motion.p variants={itemVariants} className="text-base sm:text-lg text-white/70 max-w-2xl mx-auto mb-10">
        ...
        {/* Divider */}
        <motion.div variants={itemVariants} className="w-24 h-1 bg-yellow-400 mx-auto mb-10 rounded-full" />
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 items-center justify-center">
          <motion.a
            ...
            id="hero-quote-cta"
            href="#quote"
            className="btn-pulse inline-flex items-center gap-3 bg-yellow-400 hover:bg-yellow-500 text-blue-900 font-black text-base sm:text-lg px-8 py-4 rounded-xl shadow-2xl shadow-yellow-500/40 hover:shadow-yellow-500/60 transition-all duration-200 ease-out group"
          >
          ...
          <motion.a
            ...
            className="inline-flex items-center gap-3 border-2 border-white/60 hover:border-white text-white font-bold text-base sm:text-lg px-8 py-4 rounded-xl backdrop-blur-sm hover:bg-white/10 transition-all duration-200 ease-out"
          >
        ...
        {/* Stats Bar */}
        <motion.div variants={itemVariants} className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-3xl mx-auto">
          {[
        ...
        {/* Scroll indicator */}
        <motion.div variants={itemVariants} className="mt-12 flex flex-col items-center gap-2 opacity-60">
